...
#ifndef TRAJECTORY_OP__SRV__DETAIL__SAVER__FUNCTIONS_H_
#define TRAJECTORY_OP__SRV__DETAIL__SAVER__FUNCTIONS_H_
...
#include "trajectory_op/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_trajectory_op
bool
 ...
 * calls
 * trajectory_op__srv__Saver_Request__init().
...
/**
 * It calls
 * trajectory_op__srv__Saver_Request__fini()
 ...
 * trajectory_op__srv__Saver_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * trajectory_op__srv__Saver_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trajectory_op__srv__Saver_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trajectory_op
...
/**
 * It calls
 * trajectory_op__srv__Saver_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trajectory_op
...
/**
 * It allocates the memory for the array and calls
 * trajectory_op__srv__Saver_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trajectory_op
...
/**
 * It calls
 * trajectory_op__srv__Saver_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRAJECTORY_OP__SRV__DETAIL__SAVER__FUNCTIONS_H_
