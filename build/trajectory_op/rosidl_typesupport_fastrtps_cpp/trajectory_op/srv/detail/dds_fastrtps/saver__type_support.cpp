...
#include "trajectory_op/srv/detail/saver__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_op::srv::Saver_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_op::srv::Saver_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trajectory_op::srv::Saver_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_trajectory_op
const rosidl_message_type_support_t *
get_message_type_support_handle<trajectory_op::srv::Saver_Request>()
{
  return &trajectory_op::srv::typesupport_fastrtps_cpp::_Saver_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = trajectory_op::srv::Saver_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_op::srv::Saver_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<trajectory_op::srv::Saver_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &trajectory_op::srv::typesupport_fastrtps_cpp::_Saver_Response__handle;
}
...
{
  return &trajectory_op::srv::typesupport_fastrtps_cpp::_Saver__handle;
}
